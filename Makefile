...
target_alias=snowhousecpu-unknown-elf
target_vendor=unknown
target_os=elf
target=snowhousecpu-unknown-elf

program_transform_name = s&^&snowhousecpu-unknown-elf-&
...
TOPLEVEL_CONFIGURE_ARGUMENTS=../binutils-gdb-snowhousecpu/configure --disable-nls --with-system-readline --target=snowhousecpu-unknown-elf --prefix=/home/fl4shk/local

tooldir = ${exec_prefix}/snowhousecpu-unknown-elf
build_tooldir = ${exec_prefix}/snowhousecpu-unknown-elf
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--disable-nls' '--with-system-readline' '--prefix=/home/fl4shk/local' --program-transform-name='s&^&snowhousecpu-unknown-elf-&' --disable-option-checking --disable-year2038 --with-build-subdir="$(BUILD_SUBDIR)"
...
SUBDIRS =  libiberty opcodes bfd zlib libbacktrace libdecnumber libctf libsframe binutils gas ld etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
# directories built for the host system.
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld '--disable-nls' '--with-system-readline' '--prefix=/home/fl4shk/local' --program-transform-name='s&^&snowhousecpu-unknown-elf-&' --disable-option-checking --disable-year2038
...
TARGET_SUBDIR = snowhousecpu-unknown-elf
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=x86_64-pc-linux-gnu   '--disable-nls' '--with-system-readline' '--prefix=/home/fl4shk/local' --program-transform-name='s&^&snowhousecpu-unknown-elf-&' --disable-option-checking --disable-year2038 --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
AS = as
AR = ar --plugin /usr/lib/gcc/x86_64-pc-linux-gnu/15.1.1/liblto_plugin.so
AR_FLAGS = rc
CC = gcc
CXX = g++
DLLTOOL = dlltool
...
OBJDUMP = objdump
OTOOL = otool
RANLIB = ranlib --plugin /usr/lib/gcc/x86_64-pc-linux-gnu/15.1.1/liblto_plugin.so
READELF = readelf
STRIP = strip
WINDRES = windres
WINDMC = windmc
...
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-gcc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-c++
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-gccgo
GDC_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-gdc
GM2_FOR_TARGET=$(STAGE_CC_WRAPPER) snowhousecpu-unknown-elf-gm2
DLLTOOL_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/dlltool
DSYMUTIL_FOR_TARGET=snowhousecpu-unknown-elf-dsymutil
LD_FOR_TARGET=$$r/$(HOST_SUBDIR)/ld/ld-new

LIPO_FOR_TARGET=snowhousecpu-unknown-elf-lipo
NM_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/nm-new
OBJDUMP_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/objdump
OBJCOPY_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/objcopy
OTOOL_FOR_TARGET=snowhousecpu-unknown-elf-otool
