...
#define SNOWHOUSECPU_OI_INST_UDIVW_RA_RB_RC \
  {"udivw", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 5ull}}
#define SNOWHOUSECPU_OI_INST_SDIVW_RA_RB_RC \
  {"sdivw", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 6ull}}
...
#define SNOWHOUSECPU_OI_INST_LLP_LO_RA_RB \
  {"llp", SNOWHOUSECPU_OA_LO_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 8ull}}
#define SNOWHOUSECPU_OI_INST_SCP_LO_RA_RB_RC \
  {"scp", SNOWHOUSECPU_OA_LO_RA_RB_RC, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 9ull}}
