...
#define SNOWHOUSECPU_NUM_SPRS (5ull)
...
#define SNOWHOUSECPU_SPR_ENUM_HI (0x3ull)
#define SNOWHOUSECPU_SPR_ENUM_LO (0x4ull)
...
typedef enum snowhousecpu_oparg_t
{
  ...
  //SNOWHOUSECPU_OA_RA_IDS,
  SNOWHOUSECPU_OA_IDS_RB,
  SNOWHOUSECPU_OA_RA_IRA,
  //SNOWHOUSECPU_OA_IRA_RB,
  //SNOWHOUSECPU_OA_RA_IE,
  SNOWHOUSECPU_OA_IE_RB,
  SNOWHOUSECPU_OA_IRA,
  SNOWHOUSECPU_OA_PRE_S16,
  //SNOWHOUSECPU_OA_LO_RA_RB,
  //SNOWHOUSECPU_OA_LO_RA_RB_RC,
  SNOWHOUSECPU_OA_RA_HI,
  SNOWHOUSECPU_OA_HI_RB,
...
#define SNOWHOUSECPU_OI_INST_XOR_RA_RB_SIMM16 \
  {"xor", SNOWHOUSECPU_OA_RA_RB_S16, 4ull, {0ull, SNOWHOUSECPU_SOK_RC_IDX_NZ, 0ull}}
...
#define SNOWHOUSECPU_OI_INST_CPY_RA_HI \
  {"cpy", SNOWHOUSECPU_OA_RA_HI, 7ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 11ull}}
#define SNOWHOUSECPU_OI_INST_CPY_HI_RB \
  {"cpy", SNOWHOUSECPU_OA_HI_RB, 7ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 12ull}}

#define SNOWHOUSECPU_OI_INST_UMULW_RA_RB_RC \
  {"umulw", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 0ull}}
#define SNOWHOUSECPU_OI_INST_SMULW_RA_RB_RC \
  {"smulw", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 1ull}}
#define SNOWHOUSECPU_OI_INST_UDIV_RA_RB_RC \
  {"udiv", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 2ull}}
#define SNOWHOUSECPU_OI_INST_SDIV_RA_RB_RC \
  {"sdiv", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 3ull}}
#define SNOWHOUSECPU_OI_INST_UMOD_RA_RB_RC \
  {"umod", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 4ull}}
#define SNOWHOUSECPU_OI_INST_SMOD_RA_RB_RC \
  {"smod", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 5ull}}
#define SNOWHOUSECPU_OI_INST_UDIVW_RA_RB_RC \
  {"udivw", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 6ull}}
#define SNOWHOUSECPU_OI_INST_SDIVW_RA_RB_RC \
  {"sdivw", SNOWHOUSECPU_OA_RA_RB_RC, 8ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 7ull}}
...
#define SNOWHOUSECPU_OI_INST_BGEU_RA_RB_SIMM16 \
  {"bgeu", SNOWHOUSECPU_OA_RB_RA_PCREL_S16, 10ull, {0ull, SNOWHOUSECPU_SOK_RC_IDX_FULL, 2ull}}

#define SNOWHOUSECPU_OI_INST_BGTU_RA_RB_SIMM16 \
  {"bgtu", SNOWHOUSECPU_OA_RA_RB_PCREL_S16, 10ull, {0ull, SNOWHOUSECPU_SOK_RC_IDX_FULL, 3ull}}
...
#define SNOWHOUSECPU_OI_INST_BGES_RA_RB_SIMM16 \
  {"bges", SNOWHOUSECPU_OA_RB_RA_PCREL_S16, 10ull, {0ull, SNOWHOUSECPU_SOK_RC_IDX_FULL, 4ull}}

#define SNOWHOUSECPU_OI_INST_BGTS_RA_RB_SIMM16 \
  {"bgts", SNOWHOUSECPU_OA_RA_RB_PCREL_S16, 10ull, {0ull, SNOWHOUSECPU_SOK_RC_IDX_FULL, 5ull}}
...
#define SNOWHOUSECPU_OI_INST_LLR_RA_RB \
  {"llr", SNOWHOUSECPU_OA_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 0ull}}
#define SNOWHOUSECPU_OI_INST_SCR_RA_RB_RC \
  {"scr", SNOWHOUSECPU_OA_RA_RB_RC, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 1ull}}
#define SNOWHOUSECPU_OI_INST_LLUH_RA_RB \
  {"lluh", SNOWHOUSECPU_OA_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 2ull}}
#define SNOWHOUSECPU_OI_INST_LLSH_RA_RB \
  {"llsh", SNOWHOUSECPU_OA_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 3ull}}
#define SNOWHOUSECPU_OI_INST_LLUB_RA_RB \
  {"llub", SNOWHOUSECPU_OA_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 4ull}}
#define SNOWHOUSECPU_OI_INST_LLSB_RA_RB \
  {"llsb", SNOWHOUSECPU_OA_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 5ull}}
#define SNOWHOUSECPU_OI_INST_SCH_RA_RB_RC \
  {"sch", SNOWHOUSECPU_OA_RA_RB_RC, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 6ull}}
#define SNOWHOUSECPU_OI_INST_SCB_RA_RB_RC \
  {"scb", SNOWHOUSECPU_OA_RA_RB_RC, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 7ull}}

#define SNOWHOUSECPU_OI_INST_LLP_RA_RB \
  {"llp", SNOWHOUSECPU_OA_RA_RB, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 8ull}}
#define SNOWHOUSECPU_OI_INST_SCP_RA_RB_RC \
  {"scp", SNOWHOUSECPU_OA_RA_RB_RC, 13ull, {0ull, SNOWHOUSECPU_SOK_IMM16_LO, 9ull}}
